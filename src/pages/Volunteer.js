                ...
                <div className="bodyParagraph">
                    ...
                    <div className="vol-grid">
                        <div className="text">
                            ...
                            <div className="left">
                                ...
                                <p>
                                    ...
                                    Individuals who serve on a board have the opportunity to develop and grow as
                                    leaders,
                        ...
                        <div className="images">
                            ...
                            <div className="right">
                                <img className="boardmempic" src="/assets/teamwork.jpg"/>
                            </div>
                            <div className="right">
                                <img className="fundraisepic" src="/assets/younger_players.jpg"/>
                            </div>
                        </div>
                    </div>
                </div>
